...
/* forge p44: struct mtk_dispif_info is all-u32/enum — identical 32/64
 * layout, so the compat alias is the struct itself. */
typedef struct mtk_dispif_info compat_mtk_dispif_info_t;
