...
/* 4.9 compat: struct ipc_ilm / local_para_struct come from eccci1/port_ipc.h
 * (via conn_md_exp.h). conn_md_bridge_ops has no typedef in 4.9, provide
 * the 3.18-style alias here. */
typedef struct conn_md_bridge_ops CONN_MD_BRIDGE_OPS;
typedef CONN_MD_BRIDGE_OPS *P_CONN_MD_BRIDGE_OPS;
...
extern INT32 wmt_idc_msg_from_lte_handing(struct ipc_ilm *ilm);
