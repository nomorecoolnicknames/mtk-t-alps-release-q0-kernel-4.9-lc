...
/*
 * CONFIG_MTK_IRQ_NEW_DESIGN support (irq_need_migrate_list,
 * update_affinity_settings, ...): ported verbatim from this tree's
 * arch/arm/kernel/irq.c (same 4.9 kernel API); our proven 3.18 arm64
 * tree carries the identical block in its arch/arm64/kernel/irq.c.
 */
